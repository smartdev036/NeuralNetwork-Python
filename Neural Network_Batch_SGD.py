...
#     print(idx)
#     print(np.array(x[idx,:]).reshape(1,8))
#     print(np.array(y[idx,:]).reshape(1,10))
...
for iter in range(1000):
    ...
    for idx in range(len):
        # print(idx)
        xx = np.array(x[idx,:]).reshape(1,8)
        yy = np.array(y[idx,:]).reshape(1,10)
